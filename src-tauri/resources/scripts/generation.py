...
NAF_MAP = {
    ...
    "09.90Z": "Activités de soutien aux autres industries extractives07",
    ...
    "14.39Z": "Fabrication d'autres articles à mailles10",
    ...
    "22.29B": "Fabrication de produits de consommation courante en matières plastiques21",
    ...
    "25.99B": "Fabrication d'autres articles métalliques23",
    ...
    "28.23Z": "Fabrication de machines et d'équipements de bureau (à l'exception des ordinateurs et équipementspériphériques)2824Z Fabrication d'outillage portatif à moteur incorporé",
    ...
    "31.09B": "Fabrication d'autres meubles et industries connexes de l'ameublement31",
    ...
    "42.99Z": "Construction d'autres ouvrages de génie civil n.c.a.41",
    ...
    "45.40Z": "Commerce et réparation de motocycles43",
    ...
    "46.90Z": "Commerce de gros non spécialisé46",
    ...
    "49.50Z": "Transports par conduites47",
    ...
    "63.99Z": "Autres services d'information n.c.a.60",
    ...
    "78.30Z": "Autre mise à disposition de ressources humaines78",
    ...
    "87.90B": "Hébergement social pour adultes et familles en difficultés et autre hébergement social84",
...
def main(argv: list[str]):
    ...
    kelfoncier_df = apply_filters(kelfoncier_df, powerMin)
